...
*/}}
{{- define "adhoc-redis.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "adhoc-redis.fullname" .) .Values.serviceAccount.name }}
{{- else }}
