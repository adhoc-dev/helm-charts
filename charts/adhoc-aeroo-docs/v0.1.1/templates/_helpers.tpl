...
{{- define "adhoc-libreoffice.labels" -}}
helm.sh/chart: {{ include "adhoc-aeroo.chart" . }}-libreoffice
{{ include "adhoc-libreoffice.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- end }}
{{- define "adhoc-libreoffice.selectorLabels" -}}
app.kubernetes.io/name: {{ include "adhoc-aeroo.name" . }}-libreoffice
app.kubernetes.io/instance: {{ .Release.Name }}-libreoffice
{{- end }}
